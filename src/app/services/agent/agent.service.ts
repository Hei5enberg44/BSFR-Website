...
export type SettingData<S extends SettingName> = S extends 'dm' ? DMSettingsData : never
...
export class AgentService {
    ...
    sendMessage(channelId: string, messageId: string | null, content: string, mention: boolean) {
    ...
    sendReaction(channelId: string, messageId: string, emoji: string, native: boolean) {
    ...
    updateSetting<N extends SettingName, D extends SettingData<N>>(name: N, data: D) {
