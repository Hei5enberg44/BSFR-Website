...
export class AdminService {
    ...
    getBirthdayMessages(
        ...
        return this.http.get<BirthdayMessageData>('/api/admin/birthdayMessages', {
            params: {
                first,
                rows,
                sortField,
    ...
    getCubeStalkerRequests(
        ...
        return this.http.get<CubeStalkerRequestData>('/api/admin/cubeStalkerRequests', {
            params: {
                first,
                rows,
                sortField,
    ...
    getCubeStalkerRequest(id: number) {
        return this.http.get<CubeStalkerRequest | null>('/api/admin/cubeStalkerRequest', {
            params: {
                id
            }
        })
